...
import matplotlib.pyplot as plt							#has functions that make matplotlib function like matlab 
from mpl_toolkits.mplot3d import Axes3D					#to graph in 3 dimensions
import seaborn as sns 									#visualization librray for statistical graphics
